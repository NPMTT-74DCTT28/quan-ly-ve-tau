...
<head>
    ...
    <style>
        ...
        .form-box {
            max-width: 850px;
            margin: 50px auto;
            background-color: #7fa9d6; /* gần #81aad3ff */
            padding: 35px;
            border-radius: 16px;
        }
        h2 {
    ...
    <form method="post">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="datetime-local" name="ngay_di" class="form-control"
                       value="<?= htmlspecialchars($ngay_di) ?>">
            </div>

            <div class="col-md-6">
                <label class="form-label required">Ngày đến</label>
                <input type="datetime-local" name="ngay_den" class="form-control"
                       value="<?= htmlspecialchars($ngay_den) ?>">
            </div>
